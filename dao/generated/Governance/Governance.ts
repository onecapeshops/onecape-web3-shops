...
export class DAOProposal extends ethereum.Event {
  get params(): DAOProposal__Params {
    return new DAOProposal__Params(this);
  }
}

export class DAOProposal__Params {
  _event: DAOProposal;

  constructor(event: DAOProposal) {
    this._event = event;
  }
...
export class Governance__proposalVotesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Governance extends ethereum.SmartContract {
  ...
  proposalVotes(proposalId: BigInt): Governance__proposalVotesResult {
    let result = super.call(
      "proposalVotes",
    ...
    return new Governance__proposalVotesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_proposalVotes(
    proposalId: BigInt
  ): ethereum.CallResult<Governance__proposalVotesResult> {
    let result = super.tryCall(
      "proposalVotes",
      "proposalVotes(uint256):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
    ...
    return ethereum.CallResult.fromValue(
      new Governance__proposalVotesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  votingDelay_(): BigInt {
    let result = super.call("votingDelay_", "votingDelay_():(uint256)", []);

    return result[0].toBigInt();
  }

  try_votingDelay_(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("votingDelay_", "votingDelay_():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  votingPeriod_(): BigInt {
    let result = super.call("votingPeriod_", "votingPeriod_():(uint256)", []);

    return result[0].toBigInt();
  }

  try_votingPeriod_(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "votingPeriod_",
      "votingPeriod_():(uint256)",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
