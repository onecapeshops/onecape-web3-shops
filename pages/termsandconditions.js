    ...
    <div>
      ...
      <div className={styles.globalStyle}>
        ...
        >
          ...
          <p>Welcome to onecape.in!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of Onecape Website, located at https://onecape.in.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use onecape.in if you do not agree to
          ...
          <p>
            ...
            needs in respect of the provision of the Company’s stated services,
            by and subject to, prevailing law of Netherlands. Any use of the
          ...
          <p>
            We employ the use of cookies. By accessing onecape.in, you agreed to
            use cookies in agreement with Onecape Privacy Policy.{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, Onecape and/or its licensors own the
            intellectual property rights for all material on onecape.in. All
            intellectual property rights are reserved. You may access this from
            onecape.in for your personal use subject to restrictions set in
            these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from onecape.in</li>
            <li>Sell, rent or sub-license material from onecape.in</li>
            <li>Reproduce, duplicate or copy material from onecape.in</li>
            <li>Redistribute content from onecape.in</li>
          </ul>
          ...
          <p>
            ...
            Onecape does not filter, edit, publish or review Comments before
            their presence on the website. Comments do not reflect the views and
            opinions of Onecape, its agents, and/or affiliates. Comments reflect
            the views and opinions of the person who posts their views and
            opinions. To the extent permitted by applicable laws, Onecape shall
            not be liable for the Comments or any liability, damages, or
            expenses caused and/or suffered as a result of any use of and/or
            posting of and/or appearance of the Comments on this website.
          </p>

          <p>
            Onecape reserves the right to monitor all Comments and to remove any
          ...
          <p>
            You hereby grant Onecape a non-exclusive license to use, reproduce,
            edit and authorize others to use, reproduce and edit any of your
            Comments in any forms, formats, or media.
          </p>
          ...
          <p>
            ...
            or our accredited businesses; (b) the organization does not have any
            negative records with us; (c) the benefit to us from the visibility
            of the hyperlink compensates the absence of Onecape, and (d) the
          ...
          <p>
            ...
            sending an e-mail to Onecape. Please include your name, your
          ...
          <p>
            No use of Onecape logo or other artwork will be allowed for linking
